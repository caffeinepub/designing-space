...
import type { Inquiry as _Inquiry, Time as _Time, UserProfile as _UserProfile, UserRole as _UserRole } from "./declarations/backend.did.d.ts";
export class Backend implements backendInterface {
    ...
    async getAllInquiries(arg0: null): Promise<Array<[string, Inquiry]>> {
        if (this.processError) {
            try {
                const result = await this.actor.getAllInquiries(arg0);
    ...
    async submitInquiry(arg0: string, arg1: string, arg2: string, arg3: string | null, arg4: string, arg5: string, arg6: string): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.submitInquiry(arg0, arg1, arg2, to_candid_opt_n11(this._uploadFile, this._downloadFile, arg3), arg4, arg5, arg6);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
...
function from_candid_Inquiry_n5(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: _Inquiry): Inquiry {
...
function from_candid_tuple_n4(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: [string, _Inquiry]): [string, Inquiry] {
    return [
        value[0],
        from_candid_Inquiry_n5(_uploadFile, _downloadFile, value[1])
    ];
}
...
function from_candid_vec_n3(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: Array<[string, _Inquiry]>): Array<[string, Inquiry]> {
